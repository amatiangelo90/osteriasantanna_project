...
import 'package:osteriasantannamenu/osteriasantanna/swagger.models.swagger.dart';
...
class _TableCalendarState<T> extends State<TableCalendar<T>> {
  ...
  Widget _buildSingleMarker(DateTime day, T event, double markerSize) {
    return widget.calendarBuilders.singleMarkerBuilder
        ...
        Container(
          ...
          decoration: getDecorationByEvent(widget.calendarStyle.markerDecoration, event),
        );
  }

  getDecorationByEvent(Decoration dec, T calendarConfiguration){
    CalendarConfiguration cal = calendarConfiguration as CalendarConfiguration;

    return BoxDecoration(
      color: getColorByStatus(cal),
  ...
  getColorByStatus(CalendarConfiguration cal) {
